...
using namespace std;
void welcome();
void Login();                               //declears login function
...
class elctricity_bills{                     //start the class for calculating the bill
 ...
 float energy_day;
     ...
     cout<<"\n";
		   ...
		   cout<<"\n";
	   	cout<<"enter the number of hours laptop working in day:/t      \t";
		   cin>>hor_laptop;
		   cout<<"\n";
     ...
     cout<<"*****************total energy  consumed by  appliances*****************\t\n";
		   ...
		   cout<<"the total Units consumed in a whole day\t"<<(hor_bulbs*(no_bulbs*watts_bulbs))+(hor_fans*(no_fans*watts_fans))+(hor_defrigiretor*(no_defrigiretor*watts_defrigiretor))+
		...
		////////////////////the energy cosumed in the month
	   	if(days==28)
    	{
		   cout<<"The Units consumed in month ;\t"<<fixed<<energy_day*days;
		   cout<<endl;}
		  if(days==29){
		  	cout<<"The Units consumed in month;\t"<<fixed<<energy_day*days;
		   cout<<endl;
		   ...
		   if(days==31){
		   cout<<"The Uits consumed in month:\t"<<fixed<<energy_day*days;
		   cout<<endl;
	   	}
	    cout<<"*********Convert Units Watts into Kilowatts*********\n";
	    cout<<"convert Units Watts into kiloWatts \t"<<energy_day*days/1000<<endl;
	   ...
	   ///the total cost for the electricity// 
	    if(total_e>=1&&total_e<=100){
					cout<<"\n\nThe cost ofelectricity of Month:\t"<<(total_e*1.94)<<"Rs..";
					cout<<"\n"<<"\n"<<endl;
					}
					if(total_e>100&&total_e<=300){
					cout<<"\n\nThe cost ofelectricity of Month:\t"<<(total_e*3.64)<<"Rs..";
					cout<<"\n"<<"\n"<<endl;
					}
				 else	if(total_e>300&&total_e<=1000)
					{cout<<"\n\nThe Bills of electricity Month:\t"<<(total_e*6.15)<<"Rs..";
					cout<<"\n"<<"\n";
					}
					else if(total_e>1000)
					{cout<<"\n\nThe Bills of electricity Month:\t"<<(total_e*7.14)<<"Rs..";
					cout<<"\n"<<"\n";
					}}
     };
